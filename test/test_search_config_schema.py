...
class TestSearchConfigSchema(unittest.TestCase):
    """SearchConfigSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchConfigSchema:
        """Test SearchConfigSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchConfigSchema`
        """
        model = SearchConfigSchema()
        if include_optional:
    ...
    def testSearchConfigSchema(self):
        """Test SearchConfigSchema"""
